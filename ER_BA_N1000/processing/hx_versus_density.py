...
axes = axes.flatten()
plt.sca(axes[0])
##plt.plot(ERparam,ER1["hx_avg"],'kx',label=r"ER $h_\times$",)
##plt.plot(BAparam,BA1["hx_avg"],'rx',label=r"BA $h_\times$")
##plt.plot(ERparam,ER1H["h_avg"],'ko',label=r"ER $h$")
##plt.plot(BAparam,BA1H["h_avg"],'ro',label=r"BA $h$")
plt.plot(ERparam,ER1["hx_avg"]-ER1H["h_avg"],'ko',label=r"ER")
plt.plot(BAparam,BA1["hx_avg"]-BA1H["h_avg"],'ro',label=r"BA")
plt.xlabel(r"$\langle k \rangle$")
...
plt.sca(axes[1])
##plt.plot(ERparam,ER2["hx_avg"],'kx')
##plt.plot(BAparam,BA2["hx_avg"],'rx')
##plt.plot(ERparam,ER2H["h_avg"],'ko')
##plt.plot(BAparam,BA2H["h_avg"],'ro')
plt.plot(ERparam,ER2["hx_avg"]-ER2H["h_avg"],'ko')
plt.plot(BAparam,BA2["hx_avg"]-BA2H["h_avg"],'ro')
plt.xlabel(r"$\langle k \rangle$")
plt.title(r"$q = 0.5$")

plt.sca(axes[2])
##plt.plot(ERparam,ER3["hx_avg"],'kx')
##plt.plot(BAparam,BA3["hx_avg"],'rx')
##plt.plot(ERparam,ER3H["h_avg"],'ko')
##plt.plot(BAparam,BA3H["h_avg"],'ro')
plt.plot(ERparam,ER3["hx_avg"]-ER3H["h_avg"],'ko')
plt.plot(BAparam,BA3["hx_avg"]-BA3H["h_avg"],'ro')
plt.xlabel(r"$\langle k \rangle$")
plt.title(r"$q = 0.9$")
