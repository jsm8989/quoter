...
for iz,z in enumerate(zlist):
	...
	for trial in trials_list:
		...
		file = "../data_quote/z%i_q%0.3f_T%i_lam%i_sim%i.txt" % (z,q,T,lam,trial)
	...
	theory1 = [(1/2)*(lam + math.log(t*d**lam+1)/math.log(1/d) + math.log(t)/math.log(1/d) + 2)  for t in rng]
	# theory2 = [math.log(t*(1-d))/math.log(1/d) + em/math.log(1/d) - 1/2 + 1 for t in rng]
	theory2 = [(1/2)*(lam + math.log(t*d**lam+1)/math.log(1/d) + math.log(t)/math.log(1/d) + 2)  + em/math.log(1/d) - 1/2 for t in rng]
